...
module.exports = async data => {
  ...
  if (toCreate.Disability !== undefined) {
    const value = toCreate.Disability !== "";
    toCreate.Disability = value;
  }

  if (toCreate["Veteran Status"] !== undefined) {
    const value = toCreate["Veteran Status"] !== "";
    toCreate["Veteran Status"] = value;
  }
